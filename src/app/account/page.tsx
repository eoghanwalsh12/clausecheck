...
export default function AccountPage() {
  ...
  if (!user) {
    return (
      <div className="mx-auto max-w-lg px-4 py-20 text-center text-sm text-[var(--muted-foreground)]">
    ...
    <div className="mx-auto max-w-lg px-4 py-16">
      ...
      <section className="mt-8 rounded-xl border border-[var(--border)] p-5">
        ...
        <button
          ...
          disabled={exporting}
          className="mt-4 inline-flex items-center gap-2 rounded-lg border border-[var(--border)] px-4 py-2 text-sm font-medium transition-colors hover:bg-[var(--muted)] disabled:opacity-50"
        >
          {exporting ? (
      ...
      {/* Account deletion */}
      <section className="mt-6 rounded-xl border border-[var(--destructive)]/30 p-5">
        ...
        {!confirmDelete ? (
          ...
          <div className="mt-4 rounded-lg border border-[var(--destructive)]/30 bg-[var(--destructive)]/5 p-4">
            ...
            <div className="mt-3 flex gap-2">
              <button
                ...
                disabled={deleting}
                className="inline-flex items-center gap-2 rounded-lg bg-[var(--destructive)] px-4 py-2 text-sm font-medium text-white transition-colors hover:opacity-90 disabled:opacity-50"
              >
                {deleting ? (
                  <Loader2 className="h-4 w-4 animate-spin" />
                ) : (
